...
@connect(
  ...
  {
    saveMenuCollapsed: layoutAction.saveMenuCollapsed,
...
class LayoutPage extends Component {
  ...
  toggle = () => {
    this.props.saveMenuCollapsed(!this.props.layoutReducer.get("collapsed"));
  };
  ...
  render() {
    ...
    return (
      <Layout className="layout-container">
        <Sider theme="light" trigger={null} collapsible collapsed={layoutReducer.get("collapsed")} width={218} breakpoint="lg" className="sider-container">
          <div className="logo">
            <img src={baseConfig.logo} width="32" alt="" />
            {!layoutReducer.get("collapsed") ? <span className="title">{baseConfig.company}</span> : ""}
          </div>
          <SideMenu />
        </Sider>
        <Layout className="layout-page-right-container">
          <Header className="right-header">
            <div className="right-header-left">
              <Icon className="trigger" type={layoutReducer.collapsed ? "menu-unfold" : "menu-fold"} onClick={this.toggle} />
